...
function evaluateStock() {
  if (inStock >= 1) {
    console.log(`I'm going to need some ${food}!`);
  } else {
...
function decideIfFavorite() {
  if (isFavorite === true) {
    conosle.log(`My favorite food is ${food}!`);
  } else {
...
var vegetables = ['broccoli', 'asparagus', 'tomato', 'peppers', 'onion'];
...
var fruits = ['strawberry', 'apple', 'banana', 'lemon', 'lime', 'orange', 'watermelon'];
...
var groceryStore = {
  ...
  hasParkingLot: true,
  stockedFruit: fruits,
  stockedVeggies: vegetables,
  stockedMeat: ['beef', 'chicken', 'pork', 'fish', 'impossible'],
  employeeNames: ['Dwight', 'Jim', 'Pam', 'Michael', 'Angela', 'Andy', 'Phyllis'],
  //customerInfo: [{}, {}, {}, {}]
}
